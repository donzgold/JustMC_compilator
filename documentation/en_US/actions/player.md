...
| **Name**      | **Type**                                                                    | **Description** |
| ------------- | --------------------------------------------------------------------------- | --------------- |
| `visual_fire` | Marker<br/>**FALSE** - Disable<br/>**NOT_SET** - None<br/>**TRUE** - Enable | Visual Fire     |
