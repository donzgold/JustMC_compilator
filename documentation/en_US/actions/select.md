...
| ID           | Type          | Description                                              |
|--------------|---------------|----------------------------------------------------------|
| name_or_uuid | Array\[Text\] | Name or UUID<br>The argument supports list decomposition |
...
| ID           | Type          | Description                                                            |
|--------------|---------------|------------------------------------------------------------------------|
| name_or_uuid | Array\[Text\] | Name or UUID of the target<br>The argument supports list decomposition |
