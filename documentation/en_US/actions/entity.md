...
| ID                | Type                                                 | Description       |
|-------------------|------------------------------------------------------|-------------------|
| materials         | Message 'actions.array' not found in 'ru_RU'\[Item\] | Materials         |
...
| ID      | Type                                                   | Description       |
|---------|--------------------------------------------------------|-------------------|
| effects | Message 'actions.array' not found in 'ru_RU'\[Potion\] | Effects to Remove |
...
| ID     | Type                                                   | Description                                                                                |
|--------|--------------------------------------------------------|--------------------------------------------------------------------------------------------|
| matrix | Message 'actions.array' not found in 'ru_RU'\[Number\] | creative_plus.action.entity_set_display_correct_transformation_matrix.argument.matrix.name |
...
| ID               | Type                                                   | Description      |
|------------------|--------------------------------------------------------|------------------|
| row_major_matrix | Message 'actions.array' not found in 'ru_RU'\[Number\] | 16 Number Matrix |
...
|--------------|----------------------------------------------------------------------------------------------------------------------------|-----------------|
| tag          | Text                                                                                                                       | Tag Name        |
| tag_value    | Message 'actions.array' not found in 'ru_RU'\[Text\]                                                                       | Tag Value       |
...
| ID           | Type                                                                                                                                                                                                                                                                                          | Description              |
|--------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------|
| entity_ids   | Message 'actions.array' not found in 'ru_RU'\[Text\]                                                                                                                                                                                                                                          | Name or UUID of entities |
...
| locations  | Message 'actions.array' not found in 'ru_RU'\[Location\]                                                                                                                                                             | Locations to Check                                                           |
...
| ID           | Type                                                 | Description |
|--------------|------------------------------------------------------|-------------|
| entity_types | Message 'actions.array' not found in 'ru_RU'\[Item\] | Entity Type |
