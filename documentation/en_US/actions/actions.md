...
- **[code](./code.md)**
  ...
  - [*code::dummy [ ... ]*](./code.md#control_dummy)
...
- **[controller](./controller.md)**
  ...
  - [*controller::do_not_run [ creative_plus.action.controller_do_not_run.name ]*](./controller.md#controller_do_not_run)
  - [*controller::catch_exception [ Catch Error ]*](./controller.md#controller_exception)
  - [*controller::isolated_selection [ creative_plus.action.controller_isolated_selection.name ]*](./controller.md#controller_isolated_selection)
...
- **[entity](./entity.md)**
  ...
  - [*entity::complete_using_active_item [ creative_plus.action.entity_complete_using_active_item.name ]*](./entity.md#entity_complete_using_active_item)
  ...
  - [*entity::get_attribute [ creative_plus.action.entity_get_attribute.name ]*](./entity.md#entity_get_attribute)
  - [*entity::get_custom_tag [ Get Custom Tag ]*](./entity.md#entity_get_custom_tag)
  - [*entity::get_equipment_item [ creative_plus.action.entity_get_equipment_item.name ]*](./entity.md#entity_get_equipment_item)
  - [*entity::get_nbt [ creative_plus.action.entity_get_nbt.name ]*](./entity.md#entity_get_nbt)
  ...
  - [*entity::mimic_disguise_from_entity [ creative_plus.action.entity_mimic_disguise_from_entity.name ]*](./entity.md#entity_mimic_disguise_from_entity)
  ...
  - [*entity::reset_mannequin_description [ creative_plus.action.entity_reset_mannequin_description.name ]*](./entity.md#entity_reset_mannequin_description)
  - [*entity::reset_text_display_background [ Reset Background Color ]*](./entity.md#entity_reset_text_display_background)
  - [*entity::reset_waypoint_color [ creative_plus.action.entity_reset_waypoint_color.name ]*](./entity.md#entity_reset_waypoint_color)
  - [*entity::retrieve_fishing_hook [ creative_plus.action.entity_retrieve_fishing_hook.name ]*](./entity.md#entity_retrieve_fishing_hook)
  - [*entity::ride_entity [ Ride an Entity ]*](./entity.md#entity_ride_entity)
  - [*entity::roll_armadillo [ creative_plus.action.entity_roll_armadillo.name ]*](./entity.md#entity_roll_armadillo)
  ...
  - [*entity::set_chicken_type [ creative_plus.action.entity_set_chicken_type.name ]*](./entity.md#entity_set_chicken_type)
  - [*entity::set_collidable [ Set Collidable Mode ]*](./entity.md#entity_set_collidable)
  - [*entity::set_copper_golem_oxidizing [ creative_plus.action.entity_set_copper_golem_oxidizing.name ]*](./entity.md#entity_set_copper_golem_oxidizing)
  - [*entity::set_copper_golem_oxidizing_at_time [ creative_plus.action.entity_set_copper_golem_oxidizing_at_time.name ]*](./entity.md#entity_set_copper_golem_oxidizing_at_time)
  - [*entity::set_copper_golem_weathering [ creative_plus.action.entity_set_copper_golem_weathering.name ]*](./entity.md#entity_set_copper_golem_weathering)
  - [*entity::set_cow_type [ creative_plus.action.entity_set_cow_type.name ]*](./entity.md#entity_set_cow_type)
  ...
  - [*entity::set_display_correct_transformation_matrix [ creative_plus.action.entity_set_display_correct_transformation_matrix.name ]*](./entity.md#entity_set_display_correct_transformation_matrix)
  ...
  - [*entity::set_hanging_facing_location [ creative_plus.action.entity_set_hanging_facing_location.name ]*](./entity.md#entity_set_hanging_facing_location)
  ...
  - [*entity::set_item_frame_item_drop_chance [ creative_plus.action.entity_set_item_frame_item_drop_chance.name ]*](./entity.md#entity_set_item_frame_item_drop_chance)
  - [*entity::set_item_in_frame [ Set Item in Frame ]*](./entity.md#entity_set_item_in_frame)
  - [*entity::set_item_owner [ creative_plus.action.entity_set_item_owner.name ]*](./entity.md#entity_set_item_owner)
  ...
  - [*entity::set_mannequin_description [ creative_plus.action.entity_set_mannequin_description.name ]*](./entity.md#entity_set_mannequin_description)
  - [*entity::set_mannequin_immovable [ creative_plus.action.entity_set_mannequin_immovable.name ]*](./entity.md#entity_set_mannequin_immovable)
  - [*entity::set_mannequin_main_hand [ creative_plus.action.entity_set_mannequin_main_hand.name ]*](./entity.md#entity_set_mannequin_main_hand)
  - [*entity::set_mannequin_skin [ creative_plus.action.entity_set_mannequin_skin.name ]*](./entity.md#entity_set_mannequin_skin)
  - [*entity::set_mannequin_skin_model [ creative_plus.action.entity_set_mannequin_skin_model.name ]*](./entity.md#entity_set_mannequin_skin_model)
  - [*entity::set_mannequin_skin_parts [ creative_plus.action.entity_set_mannequin_skin_parts.name ]*](./entity.md#entity_set_mannequin_skin_parts)
  - [*entity::set_mannequin_skin_patch [ creative_plus.action.entity_set_mannequin_skin_patch.name ]*](./entity.md#entity_set_mannequin_skin_patch)
  ...
  - [*entity::set_painting_art [ creative_plus.action.entity_set_painting_art.name ]*](./entity.md#entity_set_painting_art)
  ...
  - [*entity::set_persistent [ creative_plus.action.entity_set_persistent.name ]*](./entity.md#entity_set_persistent)
  ...
  - [*entity::set_pig_type [ creative_plus.action.entity_set_pig_type.name ]*](./entity.md#entity_set_pig_type)
  ...
  - [*entity::set_waypoint_color [ creative_plus.action.entity_set_waypoint_color.name ]*](./entity.md#entity_set_waypoint_color)
  - [*entity::set_waypoint_style [ creative_plus.action.entity_set_waypoint_style.name ]*](./entity.md#entity_set_waypoint_style)
  ...
  - [*entity::set_wolf_sound_variant [ creative_plus.action.entity_set_wolf_sound_variant.name ]*](./entity.md#entity_set_wolf_sound_variant)
  ...
  - [*entity::set_zombie_nautilus_variant [ creative_plus.action.entity_set_zombie_nautilus_variant.name ]*](./entity.md#entity_set_zombie_nautilus_variant)
  ...
  - [*entity::is_minecraft_tagged [ creative_plus.action.if_entity_is_minecraft_tagged.name ]*](./entity.md#if_entity_is_minecraft_tagged)
...
- **[world](./world.md)**
  ...
  - [*world::remove_tile_block_custom_tag [ creative_plus.action.game_remove_tile_block_custom_tag.name ]*](./world.md#game_remove_tile_block_custom_tag)
  ...
  - [*world::set_copper_golem_statue_pose [ creative_plus.action.game_set_copper_golem_statue_pose.name ]*](./world.md#game_set_copper_golem_statue_pose)
  - [*world::set_creaking_heart_natural [ creative_plus.action.game_set_creaking_heart_natural.name ]*](./world.md#game_set_creaking_heart_natural)
  - [*world::set_creaking_heart_state [ creative_plus.action.game_set_creaking_heart_state.name ]*](./world.md#game_set_creaking_heart_state)
  - [*world::set_decorate_pot_sherd [ Set Decorate Pot Sherd ]*](./world.md#game_set_decorate_pot_sherd)
  - [*world::set_dried_ghast_hydration [ creative_plus.action.game_set_dried_ghast_hydration.name ]*](./world.md#game_set_dried_ghast_hydration)
  - [*world::set_event_anvil_repair_cost [ creative_plus.action.game_set_event_anvil_repair_cost.name ]*](./world.md#game_set_event_anvil_repair_cost)
  - [*world::set_event_combust_duration [ creative_plus.action.game_set_event_combust_duration.name ]*](./world.md#game_set_event_combust_duration)
  - [*world::set_event_damage [ Set Event Damage ]*](./world.md#game_set_event_damage)
  - [*world::set_event_death_screen_message [ creative_plus.action.game_set_event_death_screen_message.name ]*](./world.md#game_set_event_death_screen_message)
  - [*world::set_event_enchantment_offers [ creative_plus.action.game_set_event_enchantment_offers.name ]*](./world.md#game_set_event_enchantment_offers)
  ...
  - [*world::set_event_gamemode [ creative_plus.action.game_set_event_gamemode.name ]*](./world.md#game_set_event_gamemode)
  ...
  - [*world::set_event_item_cooldown [ creative_plus.action.game_set_event_item_cooldown.name ]*](./world.md#game_set_event_item_cooldown)
  - [*world::set_event_items [ Set Event Items ]*](./world.md#game_set_event_items)
  - [*world::set_event_knockback_vector [ creative_plus.action.game_set_event_knockback_vector.name ]*](./world.md#game_set_event_knockback_vector)
  ...
  - [*world::set_event_velocity [ creative_plus.action.game_set_event_velocity.name ]*](./world.md#game_set_event_velocity)
  ...
  - [*world::set_tile_block_custom_tag [ creative_plus.action.game_set_tile_block_custom_tag.name ]*](./world.md#game_set_tile_block_custom_tag)
  - [*world::set_vault_displayed_item [ creative_plus.action.game_set_vault_displayed_item.name ]*](./world.md#game_set_vault_displayed_item)
  - [*world::set_vault_next_state_update_time [ creative_plus.action.game_set_vault_next_state_update_time.name ]*](./world.md#game_set_vault_next_state_update_time)
  ...
  - [*world::spawn_item_frame [ creative_plus.action.game_spawn_item_frame.name ]*](./world.md#game_spawn_item_frame)
  ...
  - [*world::spawn_painting [ creative_plus.action.game_spawn_painting.name ]*](./world.md#game_spawn_painting)
  ...
  - [*world::wobble_decorated_pot [ creative_plus.action.game_wobble_decorated_pot.name ]*](./world.md#game_wobble_decorated_pot)
  ...
  - [*world::event_has_input [ creative_plus.action.if_game_event_has_input.name ]*](./world.md#if_game_event_has_input)
...
- **[player](./player.md)**
  ...
  - [*player::has_input [ creative_plus.action.if_player_has_input.name ]*](./player.md#if_player_has_input)
  ...
  - [*player::allow_placing_breaking_blocks [ creative_plus.action.player_allow_placing_breaking_blocks.name ]*](./player.md#player_allow_placing_breaking_blocks)
  - [*player::boost_elytra [ Boost Elytra ]*](./player.md#player_boost_elytra)
  - [*player::clear_active_item [ creative_plus.action.player_clear_active_item.name ]*](./player.md#player_clear_active_item)
  ...
  - [*player::close_dialog_menu [ creative_plus.action.player_close_dialog_menu.name ]*](./player.md#player_close_dialog_menu)
  - [*player::close_inventory [ Close Inventory Menu ]*](./player.md#player_close_inventory)
  - [*player::complete_using_active_item [ creative_plus.action.player_complete_using_active_item.name ]*](./player.md#player_complete_using_active_item)
  - [*player::connect_to_server [ creative_plus.action.player_connect_to_server.name ]*](./player.md#player_connect_to_server)
  ...
  - [*player::force_flight_mode [ creative_plus.action.player_force_flight_mode.name ]*](./player.md#player_force_flight_mode)
  - [*player::get_attribute [ creative_plus.action.player_get_attribute.name ]*](./player.md#player_get_attribute)
  - [*player::get_nbt [ creative_plus.action.player_get_nbt.name ]*](./player.md#player_get_nbt)
  ...
  - [*player::mimic_disguise_from_entity [ creative_plus.action.player_mimic_disguise_from_entity.name ]*](./player.md#player_mimic_disguise_from_entity)
  ...
  - [*player::open_ender_chest [ creative_plus.action.player_open_ender_chest.name ]*](./player.md#player_open_ender_chest)
  - [*player::open_working_menu [ creative_plus.action.player_open_working_menu.name ]*](./player.md#player_open_working_menu)
  ...
  - [*player::reset_waypoint_color [ creative_plus.action.player_reset_waypoint_color.name ]*](./player.md#player_reset_waypoint_color)
  ...
  - [*player::set_death_screen_score [ creative_plus.action.player_set_death_screen_score.name ]*](./player.md#player_set_death_screen_score)
  ...
  - [*player::set_inventory_menu_custom_id [ creative_plus.action.player_set_inventory_menu_custom_id.name ]*](./player.md#player_set_inventory_menu_custom_id)
  ...
  - [*player::set_item_group_cooldown [ creative_plus.action.player_set_item_group_cooldown.name ]*](./player.md#player_set_item_group_cooldown)
  ...
  - [*player::set_waypoint_color [ creative_plus.action.player_set_waypoint_color.name ]*](./player.md#player_set_waypoint_color)
  - [*player::set_waypoint_style [ creative_plus.action.player_set_waypoint_style.name ]*](./player.md#player_set_waypoint_style)
  ...
  - [*player::show_dialog_menu_from_nbt [ creative_plus.action.player_show_dialog_menu_from_nbt.name ]*](./player.md#player_show_dialog_menu_from_nbt)
  ...
  - [*player::start_using_item [ creative_plus.action.player_start_using_item.name ]*](./player.md#player_start_using_item)
  ...
  - [*player::send_currency_transaction [ creative_plus.action.send_currency_transaction.name ]*](./player.md#send_currency_transaction)
- **[variable](./variable.md)**
  - [*variable::block_is_minecraft_tagged [ creative_plus.action.if_variable_block_is_minecraft_tagged.name ]*](./variable.md#if_variable_block_is_minecraft_tagged)
  ...
  - [*variable::item_is_minecraft_tagged [ creative_plus.action.if_variable_item_is_minecraft_tagged.name ]*](./variable.md#if_variable_item_is_minecraft_tagged)
  ...
  - [*variable::number_in_range [ creative_plus.action.if_variable_number_in_range.name ]*](./variable.md#if_variable_number_in_range)
  ...
  - [*variable::bytes_to_text [ Convert bytes to text ]*](./variable.md#set_variable_bytes_to_text)
  ...
  - [*variable::chunk_text [ creative_plus.action.set_variable_chunk_text.name ]*](./variable.md#set_variable_chunk_text)
  - [*variable::clamp [ Clamp Number ]*](./variable.md#set_variable_clamp)
  - [*variable::clamp_location [ creative_plus.action.set_variable_clamp_location.name ]*](./variable.md#set_variable_clamp_location)
  ...
  - [*variable::code_bytes [ creative_plus.action.set_variable_code_bytes.name ]*](./variable.md#set_variable_code_bytes)
  ...
  - [*variable::create_head_object_component [ creative_plus.action.set_variable_create_head_object_component.name ]*](./variable.md#set_variable_create_head_object_component)
  ...
  - [*variable::create_sprite_object_component [ creative_plus.action.set_variable_create_sprite_object_component.name ]*](./variable.md#set_variable_create_sprite_object_component)
  ...
  - [*variable::edit_item_custom_model_data [ creative_plus.action.set_variable_edit_item_custom_model_data.name ]*](./variable.md#set_variable_edit_item_custom_model_data)
  - [*variable::face_location [ Location Face Another Location ]*](./variable.md#set_variable_face_location)
  - [*variable::find_nearest_location [ creative_plus.action.set_variable_find_nearest_location.name ]*](./variable.md#set_variable_find_nearest_location)
  - [*variable::find_nearest_number [ creative_plus.action.set_variable_find_nearest_number.name ]*](./variable.md#set_variable_find_nearest_number)
  ...
  - [*variable::gamma_function [ creative_plus.action.set_variable_gamma_function.name ]*](./variable.md#set_variable_gamma_function)
  ...
  - [*variable::get_blocks_by_tag [ creative_plus.action.set_variable_get_blocks_by_tag.name ]*](./variable.md#set_variable_get_blocks_by_tag)
  ...
  - [*variable::get_entity_types_by_tag [ creative_plus.action.set_variable_get_entity_types_by_tag.name ]*](./variable.md#set_variable_get_entity_types_by_tag)
  ...
  - [*variable::get_item_attack_range [ creative_plus.action.set_variable_get_item_attack_range.name ]*](./variable.md#set_variable_get_item_attack_range)
  - [*variable::get_item_attribute [ Get Item Attribute ]*](./variable.md#set_variable_get_item_attribute)
  - [*variable::get_item_break_sound [ creative_plus.action.set_variable_get_item_break_sound.name ]*](./variable.md#set_variable_get_item_break_sound)
  - [*variable::get_item_color [ Get Item Color ]*](./variable.md#set_variable_get_item_color)
  - [*variable::get_item_component [ creative_plus.action.set_variable_get_item_component.name ]*](./variable.md#set_variable_get_item_component)
  ...
  - [*variable::get_item_effective_name [ creative_plus.action.set_variable_get_item_effective_name.name ]*](./variable.md#set_variable_get_item_effective_name)
  - [*variable::get_item_enchantments [ Get Item Enchantments ]*](./variable.md#set_variable_get_item_enchantments)
  - [*variable::get_item_food_properties [ creative_plus.action.set_variable_get_item_food_properties.name ]*](./variable.md#set_variable_get_item_food_properties)
  ...
  - [*variable::get_item_minimum_attack_charge [ creative_plus.action.set_variable_get_item_minimum_attack_charge.name ]*](./variable.md#set_variable_get_item_minimum_attack_charge)
  - [*variable::get_item_model_data [ creative_plus.action.set_variable_get_item_model_data.name ]*](./variable.md#set_variable_get_item_model_data)
  ...
  - [*variable::get_item_swing_animation [ creative_plus.action.set_variable_get_item_swing_animation.name ]*](./variable.md#set_variable_get_item_swing_animation)
  - [*variable::get_item_tooltip_style [ creative_plus.action.set_variable_get_item_tooltip_style.name ]*](./variable.md#set_variable_get_item_tooltip_style)
  - [*variable::get_item_type [ Get Item Type ]*](./variable.md#set_variable_get_item_type)
  - [*variable::get_item_use_remainder [ creative_plus.action.set_variable_get_item_use_remainder.name ]*](./variable.md#set_variable_get_item_use_remainder)
  - [*variable::get_item_weapon [ creative_plus.action.set_variable_get_item_weapon.name ]*](./variable.md#set_variable_get_item_weapon)
  - [*variable::get_items_by_tag [ creative_plus.action.set_variable_get_items_by_tag.name ]*](./variable.md#set_variable_get_items_by_tag)
  ...
  - [*variable::get_text_regex_groups [ creative_plus.action.set_variable_get_text_regex_groups.name ]*](./variable.md#set_variable_get_text_regex_groups)
  - [*variable::get_text_similarity [ creative_plus.action.set_variable_get_text_similarity.name ]*](./variable.md#set_variable_get_text_similarity)
  - [*variable::get_text_width [ Get Text Width In Pixels ]*](./variable.md#set_variable_get_text_width)
  - [*variable::get_tile_block_custom_tag [ creative_plus.action.set_variable_get_tile_block_custom_tag.name ]*](./variable.md#set_variable_get_tile_block_custom_tag)
  - [*variable::get_tile_block_nbt [ creative_plus.action.set_variable_get_tile_block_nbt.name ]*](./variable.md#set_variable_get_tile_block_nbt)
  - [*variable::get_vault_displayed_item [ creative_plus.action.set_variable_get_vault_displayed_item.name ]*](./variable.md#set_variable_get_vault_displayed_item)
  - [*variable::get_vault_next_state_update_time [ creative_plus.action.set_variable_get_vault_next_state_update_time.name ]*](./variable.md#set_variable_get_vault_next_state_update_time)
  ...
  - [*variable::hadamard_vector_product [ creative_plus.action.set_variable_hadamard_vector_product.name ]*](./variable.md#set_variable_hadamard_vector_product)
  - [*variable::get_text_hash [ Get Text Hash ]*](./variable.md#set_variable_hash)
  - [*variable::hide_item_components [ creative_plus.action.set_variable_hide_item_components.name ]*](./variable.md#set_variable_hide_item_components)
  ...
  - [*variable::mathematical_expectation [ creative_plus.action.set_variable_mathematical_expectation.name ]*](./variable.md#set_variable_mathematical_expectation)
  - [*variable::max [ Maximum Value ]*](./variable.md#set_variable_max)
  - [*variable::median [ creative_plus.action.set_variable_median.name ]*](./variable.md#set_variable_median)
  - [*variable::min [ Minimum Value ]*](./variable.md#set_variable_min)
  - [*variable::set_values [ creative_plus.action.set_variable_multiple.name ]*](./variable.md#set_variable_multiple)
  ...
  - [*variable::obtain_item_custom_model_data [ creative_plus.action.set_variable_obtain_item_custom_model_data.name ]*](./variable.md#set_variable_obtain_item_custom_model_data)
  ...
  - [*variable::set_component_shadow_color [ creative_plus.action.set_variable_set_component_shadow_color.name ]*](./variable.md#set_variable_set_component_shadow_color)
  ...
  - [*variable::set_item_attack_range [ creative_plus.action.set_variable_set_item_attack_range.name ]*](./variable.md#set_variable_set_item_attack_range)
  - [*variable::set_item_attribute [ Add Attribute To Item ]*](./variable.md#set_variable_set_item_attribute)
  - [*variable::set_item_break_sound [ creative_plus.action.set_variable_set_item_break_sound.name ]*](./variable.md#set_variable_set_item_break_sound)
  ...
  - [*variable::set_item_food_properties [ creative_plus.action.set_variable_set_item_food_properties.name ]*](./variable.md#set_variable_set_item_food_properties)
  - [*variable::set_item_glider [ creative_plus.action.set_variable_set_item_glider.name ]*](./variable.md#set_variable_set_item_glider)
  - [*variable::set_item_glint_override [ creative_plus.action.set_variable_set_item_glint_override.name ]*](./variable.md#set_variable_set_item_glint_override)
  - [*variable::set_item_hidden_tooltip [ creative_plus.action.set_variable_set_item_hidden_tooltip.name ]*](./variable.md#set_variable_set_item_hidden_tooltip)
  ...
  - [*variable::set_item_minimum_attack_charge [ creative_plus.action.set_variable_set_item_minimum_attack_charge.name ]*](./variable.md#set_variable_set_item_minimum_attack_charge)
  - [*variable::set_item_model_data [ creative_plus.action.set_variable_set_item_model_data.name ]*](./variable.md#set_variable_set_item_model_data)
  - [*variable::set_item_name [ Set Item Name ]*](./variable.md#set_variable_set_item_name)
  - [*variable::set_item_piercing_weapon [ creative_plus.action.set_variable_set_item_piercing_weapon.name ]*](./variable.md#set_variable_set_item_piercing_weapon)
  - [*variable::set_item_placeable_blocks [ Set Item Placeable Blocks ]*](./variable.md#set_variable_set_item_placeable_blocks)
  - [*variable::set_item_rarity [ creative_plus.action.set_variable_set_item_rarity.name ]*](./variable.md#set_variable_set_item_rarity)
  - [*variable::set_item_swing_animation [ creative_plus.action.set_variable_set_item_swing_animation.name ]*](./variable.md#set_variable_set_item_swing_animation)
  - [*variable::set_item_tooltip_style [ creative_plus.action.set_variable_set_item_tooltip_style.name ]*](./variable.md#set_variable_set_item_tooltip_style)
  ...
  - [*variable::set_item_use_effects [ creative_plus.action.set_variable_set_item_use_effects.name ]*](./variable.md#set_variable_set_item_use_effects)
  - [*variable::set_item_use_remainder [ creative_plus.action.set_variable_set_item_use_remainder.name ]*](./variable.md#set_variable_set_item_use_remainder)
  - [*variable::set_item_visibility_flags [ Set Item Visibility Flags ]*](./variable.md#set_variable_set_item_visibility_flags)
  - [*variable::set_item_weapon [ creative_plus.action.set_variable_set_item_weapon.name ]*](./variable.md#set_variable_set_item_weapon)
  ...
  - [*variable::split_text_by_length [ creative_plus.action.set_variable_split_text_by_length.name ]*](./variable.md#set_variable_split_text_by_length)
  ...
  - [*variable::text_to_bytes [ Convert text to bytes ]*](./variable.md#set_variable_text_to_bytes)
  - [*variable::text_to_chars [ creative_plus.action.set_variable_text_to_chars.name ]*](./variable.md#set_variable_text_to_chars)
  ...
  - [*variable::unset_item_components [ creative_plus.action.set_variable_unset_item_components.name ]*](./variable.md#set_variable_unset_item_components)
