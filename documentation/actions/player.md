...
**Имя:** Скрыть визуализаторы\
**Тип:** Действие без значения\
**Описание:** Скрывает от игрока все визуалиторы в выбранном пространстве, не влияя на других игроков.
...
**Пример использования:** 
```ts
player::set_chat_completions(["Подсказки", "Подсказки"],"ADD");
```
...
**Тип:** Действие без значения\
**Описание:** Устаналивает игроку тик-рейт, не влияя на других игроков.
