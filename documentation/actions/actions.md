...
- **[player](./player.md)**
  ...
  - [*player::remove_display_blocks [ Скрыть визуализаторы ]*](./player.md#player_remove_display_blocks)
...
- **[entity](./entity.md)**
  ...
  - [*entity::set_primed_tnt_block [ Замаскировать зажженный динамит под блок ]*](./entity.md#entity_set_primed_tnt_block)
