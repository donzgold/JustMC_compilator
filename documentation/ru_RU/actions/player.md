...
| ID            | Тип             | Описание                                               |
|---------------|-----------------|--------------------------------------------------------|
| chat_messages | Список\[Текст\] | Сообщение<br/>Аргумент поддерживает разложение списков |
...
| ID              | Тип                                                                                                                                                                                                                         | Описание                                                              |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------|
| slots           | Список\[Число\]                                                                                                                                                                                                             | Номер слота для проверки<br/>Аргумент поддерживает разложение списков |
| items           | Список\[Предмет\]                                                                                                                                                                                                           | Предметы для проверки<br/>Аргумент поддерживает разложение списков    |
| comparison_mode | Маркер<br/>**EXACTLY** - Полное сравнение<br/>**IGNORE_DURABILITY_AND_STACK_SIZE** - Игнорировать количество и прочность<br/>**IGNORE_STACK_SIZE** - Игнорировать только количество<br/>**TYPE_ONLY** - Только тип предмета | Режим сравнения                                                       |
...
| ID         | Тип                                                                                                                               | Описание                                                                    |
|------------|-----------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------|
| blocks     | Список\[Блок\]                                                                                                                    | Блок(и) для проверки<br/>Аргумент поддерживает разложение списков           |
| locations  | Список\[Местоположение\]                                                                                                          | Местоположение(я) для проверки<br/>Аргумент поддерживает разложение списков |
...
| ID           | Тип                                                                                                                                                                                                                                                                                          | Описание                                                                             |
|--------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------|
| entity_ids   | Список\[Текст\]                                                                                                                                                                                                                                                                              | Имя, UUID или тип существа для проверки<br/>Аргумент поддерживает разложение списков |
...
| locations  | Список\[Местоположение\]                                     | Местоположение для проверки<br/>Аргумент поддерживает разложение списков |
...
| ID              | Тип                                                                                                                                                                                                                         | Описание                                                          |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| items           | Список\[Предмет\]                                                                                                                                                                                                           | Предмет для проверки<br/>Аргумент поддерживает разложение списков |
...
| ID     | Тип                                                                                                                                                                                                                    | Описание                                                                                                                    |
|--------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------------------------------------------------------------------|
| blocks | Список\[Блок\]                                                                                                                                                                                                         | creative_plus.action.player_allow_placing_breaking_blocks.argument.blocks.name<br/>Аргумент поддерживает разложение списков |
...
| ID    | Тип               | Описание                                                          |
|-------|-------------------|-------------------------------------------------------------------|
| items | Список\[Предмет\] | Предметы для очистки<br/>Аргумент поддерживает разложение списков |
...
| ID       | Тип                      | Описание                                                          |
|----------|--------------------------|-------------------------------------------------------------------|
| location | Список\[Местоположение\] | Местоположение блока<br/>Аргумент поддерживает разложение списков |
...
| ID       | Тип                      | Описание                                                                   |
|----------|--------------------------|----------------------------------------------------------------------------|
| particle | Список\[Эффект частиц\]  | Эффект частиц для отображения<br/>Аргумент поддерживает разложение списков |
| location | Список\[Местоположение\] | Местоположение эффекта<br/>Аргумент поддерживает разложение списков        |
...
| ID     | Тип               | Описание                                                         |
|--------|-------------------|------------------------------------------------------------------|
| items  | Список\[Предмет\] | Предметы для выдачи<br/>Аргумент поддерживает разложение списков |
...
| ID    | Тип               | Описание                                                         |
|-------|-------------------|------------------------------------------------------------------|
| items | Список\[Предмет\] | Предметы для выбора<br/>Аргумент поддерживает разложение списков |
...
|--------------|----------------|--------------------------------------------------------------------|
| name_or_uuid | Текст          | Имя или UUID сущности                                              |
| sounds       | Список\[Звук\] | Звук для проигрывания<br/>Аргумент поддерживает разложение списков |
...
| ID       | Тип            | Описание                                                            |
|----------|----------------|---------------------------------------------------------------------|
| sounds   | Список\[Звук\] | Звуки для проигрывания<br/>Аргумент поддерживает разложение списков |
| location | Местоположение | Местоположение звука                                                |
...
| ID            | Тип                                                      | Описание                                                           |
|---------------|----------------------------------------------------------|--------------------------------------------------------------------|
| locations     | Список\[Местоположение\]                                 | Позиции для телепорта<br/>Аргумент поддерживает разложение списков |
...
| ID    | Тип               | Описание                                                           |
|-------|-------------------|--------------------------------------------------------------------|
| items | Список\[Предмет\] | Предметы для удаления<br/>Аргумент поддерживает разложение списков |
...
| ID      | Тип             | Описание                                                          |
|---------|-----------------|-------------------------------------------------------------------|
| potions | Список\[Зелье\] | Эффекты для удаления<br/>Аргумент поддерживает разложение списков |
...
| ID       | Тип                                                                             | Описание                                                           |
|----------|---------------------------------------------------------------------------------|--------------------------------------------------------------------|
| messages | Список\[Текст\]                                                                 | Сообщения в экшн-баре<br/>Аргумент поддерживает разложение списков |
...
| ID       | Тип             | Описание                                                        |
|----------|-----------------|-----------------------------------------------------------------|
| messages | Список\[Текст\] | Текст для отправки<br/>Аргумент поддерживает разложение списков |
...
| ID           | Тип                                                                             | Описание                                               |
|--------------|---------------------------------------------------------------------------------|--------------------------------------------------------|
| completions  | Список\[Текст\]                                                                 | Подсказки<br/>Аргумент поддерживает разложение списков |
...
| ID    | Тип               | Описание                                                                                 |
|-------|-------------------|------------------------------------------------------------------------------------------|
| items | Список\[Предмет\] | Предметы для выдачи в соответствующие слоты<br/>Аргумент поддерживает разложение списков |
...
| ID       | Тип                                                                                                                           | Описание                                                            |
|----------|-------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| text     | Список\[Текст\]                                                                                                               | Текст в списке игроков<br/>Аргумент поддерживает разложение списков |
| merging  | Маркер<br/>**CONCATENATION** - Объединение<br/>**SEPARATE_LINES** - Разделение на строки<br/>**SPACES** - Разделение пробелом | Объединение текста                                                  |
...
| ID             | Тип                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              | Описание                                                        |
|----------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| items          | Список\[Предмет\]                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                | Предметы инвентаря<br/>Аргумент поддерживает разложение списков |
...
| ID     | Тип            | Описание                                                           |
|--------|----------------|--------------------------------------------------------------------|
| sounds | Список\[Звук\] | Эффекты для остановки<br/>Аргумент поддерживает разложение списков |
