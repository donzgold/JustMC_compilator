...
| ID           | Тип                                                   | Описание          |
|--------------|-------------------------------------------------------|-------------------|
| name_or_uuid | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Имя или UUID моба |
...
| ID           | Тип                                                   | Описание            |
|--------------|-------------------------------------------------------|---------------------|
| name_or_uuid | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Имя или UUID игрока |
...
| ID           | Тип                                                   | Описание          |
|--------------|-------------------------------------------------------|-------------------|
| name_or_uuid | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Имя или UUID цели |
