...
| ID        | Тип                                                      | Описание                                                          |
|-----------|----------------------------------------------------------|-------------------------------------------------------------------|
| locations | Список\[Местоположение\]                                 | Местоположения блоков<br>Аргумент поддерживает разложение списков |
...
| ID       | Тип               | Описание                                             |
|----------|-------------------|------------------------------------------------------|
| items    | Список\[Предмет\] | Предметы<br>Аргумент поддерживает разложение списков |
| location | Местоположение    | Местоположение контейнера                            |
...
| ID       | Тип                      | Описание                                                          |
|----------|--------------------------|-------------------------------------------------------------------|
| location | Список\[Местоположение\] | Местоположения блоков<br>Аргумент поддерживает разложение списков |
...
| ID       | Тип               | Описание                                                            |
|----------|-------------------|---------------------------------------------------------------------|
| items    | Список\[Предмет\] | Предметы для заполнения<br>Аргумент поддерживает разложение списков |
| location | Местоположение    | Местоположение контейнера                                           |
...
| ID        | Тип            | Описание                                                     |
|-----------|----------------|--------------------------------------------------------------|
| old_block | Список\[Блок\] | Блоки для замены<br>Аргумент поддерживает разложение списков |
| pos_1     | Местоположение | Угол региона                                                 |
| pos_2     | Местоположение | Противоположный угол региона                                 |
...
| ID            | Тип                                                          | Описание                                                                   |
|---------------|--------------------------------------------------------------|----------------------------------------------------------------------------|
| locations     | Список\[Местоположение\]                                     | Местоположения установки блока<br>Аргумент поддерживает разложение списков |
| block         | Блок                                                         | Блок                                                                       |
...
| ID       | Тип                      | Описание                                                              |
|----------|--------------------------|-----------------------------------------------------------------------|
| items    | Список\[Предмет\]        | Предметы для установки<br>Аргумент поддерживает разложение списков    |
| location | Список\[Местоположение\] | Местоположение контейнера<br>Аргумент поддерживает разложение списков |
...
| ID           | Тип             | Описание                                                             |
|--------------|-----------------|----------------------------------------------------------------------|
| enchantments | Список\[Текст\] | Предлагаемые зачарования<br>Аргумент поддерживает разложение списков |
| levels       | Список\[Текст\] | Уровни зачарований<br>Аргумент поддерживает разложение списков       |
| costs        | Список\[Текст\] | Стоимость зачарований<br>Аргумент поддерживает разложение списков    |
...
| effects     | Список\[Зелье\] | Эффекты зелья<br>Аргумент поддерживает разложение списков |
...
| custom_name       | Текст                                                    | Имя                                                 |
| potion_effects    | Список\[Зелье\]                                          | Эффекты<br>Аргумент поддерживает разложение списков |
...
| ID       | Тип            | Описание                                                           |
|----------|----------------|--------------------------------------------------------------------|
| blocks   | Список\[Блок\] | Тип блока для проверки<br>Аргумент поддерживает разложение списков |
| location | Местоположение | Местоположение блока                                               |
...
| ID         | Тип                                                                                | Описание                                                         |
|------------|------------------------------------------------------------------------------------|------------------------------------------------------------------|
| locations  | Список\[Местоположение\]                                                           | Местоположение блока<br>Аргумент поддерживает разложение списков |
...
| ID              | Тип                                                                                                                                                                                                                         | Описание                                                          |
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------|
| items           | Список\[Предмет\]                                                                                                                                                                                                           | Предметы для проверки<br>Аргумент поддерживает разложение списков |
| location        | Местоположение                                                                                                                                                                                                              | Местоположение контейнера                                         |
...
| ID        | Тип                      | Описание                                                                       |
|-----------|--------------------------|--------------------------------------------------------------------------------|
| blocks    | Список\[Блок\]           | Типы блоков для проверки<br>Аргумент поддерживает разложение списков           |
| locations | Список\[Местоположение\] | Местоположения блоков для проверки<br>Аргумент поддерживает разложение списков |
...
| ID             | Тип             | Описание                                                        |
|----------------|-----------------|-----------------------------------------------------------------|
| names_or_uuids | Список\[Текст\] | Ник игрока или UUID<br>Аргумент поддерживает разложение списков |
...
|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|----------------------------------------------------------------|
| location   | Местоположение                                                                                                                                                                                                                                                            | Местоположение таблички                                        |
| texts      | Список\[Текст\]                                                                                                                                                                                                                                                           | Текст для проверки<br>Аргумент поддерживает разложение списков |
