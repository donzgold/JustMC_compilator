...
**Имя:** Установить позу статуи медного голема\
**Тип:** Действие без значения\
**Описание:** Устанавливает указанную позу для статуи медного голема на указанном местоположении.\
**Работает с:**\
&nbsp;&nbsp;Статуями медного голема
...
| ID       | Тип                                                                                                               | Описание              |
|----------|-------------------------------------------------------------------------------------------------------------------|-----------------------|
| location | Местоположение                                                                                                    | Местоположение статуи |
| pose     | Маркер<br/>**STANDING** - Стояние<br/>**SITTING** - Сидение<br/>**RUNNING** - Бег<br/>**STAR** - Поза "Звёздочка" | Поза                  |
...
**Имя:** Установить качание вазы\
**Тип:** Действие без значения\
**Описание:** Устанавливает указанный тип качания вазы на указанном местоположении.\
**Работает с:**\
&nbsp;&nbsp;Вазами
...
|----------|--------------------------------------------------------------------|---------------------|
| location | Местоположение                                                     | Местоположение вазы |
| style    | Маркер<br/>**POSITIVE** - Позитивное<br/>**NEGATIVE** - Негативное | Тип качания         |
