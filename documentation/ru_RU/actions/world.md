...
| ID       | Тип                                                            | Описание              |
|----------|----------------------------------------------------------------|-----------------------|
| location | Message 'actions.array' not found in 'ru_RU'\[Местоположение\] | Местоположения блоков |
...
| ID        | Тип                                                  | Описание                     |
|-----------|------------------------------------------------------|------------------------------|
| old_block | Message 'actions.array' not found in 'ru_RU'\[Блок\] | Блоки для замены             |
| pos_1     | Местоположение                                       | Угол региона                 |
| pos_2     | Местоположение                                       | Противоположный угол региона |
...
| ID            | Тип                                                            | Описание                       |
|---------------|----------------------------------------------------------------|--------------------------------|
| locations     | Message 'actions.array' not found in 'ru_RU'\[Местоположение\] | Местоположения установки блока |
| block         | Блок                                                           | Блок                           |
...
| location | Message 'actions.array' not found in 'ru_RU'\[Местоположение\] | Местоположение контейнера |
...
| ID           | Тип                                                   | Описание                 |
|--------------|-------------------------------------------------------|--------------------------|
| enchantments | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Предлагаемые зачарования |
| levels       | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Уровни зачарований       |
| costs        | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Стоимость зачарований    |
...
| effects     | Message 'actions.array' not found in 'ru_RU'\[Зелье\] | Эффекты зелья  |
...
| custom_name       | Текст                                                    | Имя                            |
| potion_effects    | Message 'actions.array' not found in 'ru_RU'\[Зелье\]    | Эффекты                        |
...
| ID       | Тип                                                  | Описание               |
|----------|------------------------------------------------------|------------------------|
| blocks   | Message 'actions.array' not found in 'ru_RU'\[Блок\] | Тип блока для проверки |
| location | Местоположение                                       | Местоположение блока   |
...
| ID         | Тип                                                                                | Описание                   |
|------------|------------------------------------------------------------------------------------|----------------------------|
| locations  | Message 'actions.array' not found in 'ru_RU'\[Местоположение\]                     | Местоположение блока       |
...
| ID        | Тип                                                            | Описание                           |
|-----------|----------------------------------------------------------------|------------------------------------|
| blocks    | Message 'actions.array' not found in 'ru_RU'\[Блок\]           | Типы блоков для проверки           |
| locations | Message 'actions.array' not found in 'ru_RU'\[Местоположение\] | Местоположения блоков для проверки |
...
| ID             | Тип                                                   | Описание            |
|----------------|-------------------------------------------------------|---------------------|
| names_or_uuids | Message 'actions.array' not found in 'ru_RU'\[Текст\] | Ник игрока или UUID |
...
|------------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------|
| location   | Местоположение                                                                                                                                                                                                                                                            | Местоположение таблички |
| texts      | Message 'actions.array' not found in 'ru_RU'\[Текст\]                                                                                                                                                                                                                     | Текст для проверки      |
