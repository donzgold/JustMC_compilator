...
- **[controller](./controller.md)**
  ...
  - [*controller::do_not_run [ Игнорировать выполнение ]*](./controller.md#controller_do_not_run)
  - [*controller::catch_exception [ Уловить ошибку ]*](./controller.md#controller_exception)
  - [*controller::isolated_selection [ Изолировать выборку ]*](./controller.md#controller_isolated_selection)
...
- **[entity](./entity.md)**
  ...
  - [*entity::complete_using_active_item [ Завершить использование предмета ]*](./entity.md#entity_complete_using_active_item)
  ...
  - [*entity::get_equipment_item [ Получить снаряжение сущности ]*](./entity.md#entity_get_equipment_item)
  ...
  - [*entity::mimic_disguise_from_entity [ Замаскировать сущность под сущность из мира ]*](./entity.md#entity_mimic_disguise_from_entity)
  ...
  - [*entity::reset_mannequin_description [ Очистить описание маникена ]*](./entity.md#entity_reset_mannequin_description)
  - [*entity::reset_text_display_background [ Сбросить цвет фона ]*](./entity.md#entity_reset_text_display_background)
  - [*entity::reset_waypoint_color [ Сбросить цвет значка на локаторе ]*](./entity.md#entity_reset_waypoint_color)
  ...
  - [*entity::set_copper_golem_oxidizing [ Установить вощённость медного голема ]*](./entity.md#entity_set_copper_golem_oxidizing)
  - [*entity::set_copper_golem_oxidizing_at_time [ Установить время окисления медного голема ]*](./entity.md#entity_set_copper_golem_oxidizing_at_time)
  - [*entity::set_copper_golem_weathering [ Установить окисление медного голема ]*](./entity.md#entity_set_copper_golem_weathering)
  ...
  - [*entity::set_display_correct_transformation_matrix [ Установить матрицу преобразования ]*](./entity.md#entity_set_display_correct_transformation_matrix)
  ...
  - [*entity::set_hanging_facing_location [ Установить сторону блока для висящей сущности ]*](./entity.md#entity_set_hanging_facing_location)
  ...
  - [*entity::set_mannequin_description [ Установить описание маникена ]*](./entity.md#entity_set_mannequin_description)
  - [*entity::set_mannequin_immovable [ Установить передвижение маникена ]*](./entity.md#entity_set_mannequin_immovable)
  - [*entity::set_mannequin_main_hand [ Установить ведущую руку маникена ]*](./entity.md#entity_set_mannequin_main_hand)
  - [*entity::set_mannequin_skin [ Установить скин маникена ]*](./entity.md#entity_set_mannequin_skin)
  - [*entity::set_mannequin_skin_model [ Установить тип модели маникена ]*](./entity.md#entity_set_mannequin_skin_model)
  - [*entity::set_mannequin_skin_parts [ Установить слои скина маникена ]*](./entity.md#entity_set_mannequin_skin_parts)
  - [*entity::set_mannequin_skin_patch [ Установить текстуру части маникена ]*](./entity.md#entity_set_mannequin_skin_patch)
  ...
  - [*entity::set_waypoint_color [ Установить цвет значка на локаторе ]*](./entity.md#entity_set_waypoint_color)
  - [*entity::set_waypoint_style [ Установить стиль значка на локаторе ]*](./entity.md#entity_set_waypoint_style)
  ...
  - [*entity::set_zombie_nautilus_variant [ Установить тип зомби-наутилуса ]*](./entity.md#entity_set_zombie_nautilus_variant)
  ...
  - [*entity::is_minecraft_tagged [ Имеет Minecraft-тег ]*](./entity.md#if_entity_is_minecraft_tagged)
...
- **[world](./world.md)**
  ...
  - [*world::remove_tile_block_custom_tag [ Удалить кастомный тег блока-сущности ]*](./world.md#game_remove_tile_block_custom_tag)
  ...
  - [*world::set_copper_golem_statue_pose [ Установить позу статуи медного голема ]*](./world.md#game_set_copper_golem_statue_pose)
  ...
  - [*world::set_tile_block_custom_tag [ Установить кастомный тег блоку-сущности ]*](./world.md#game_set_tile_block_custom_tag)
  ...
  - [*world::wobble_decorated_pot [ Установить качание вазы ]*](./world.md#game_wobble_decorated_pot)
...
- **[player](./player.md)**
  ...
  - [*player::clear_active_item [ Прервать использование предмета ]*](./player.md#player_clear_active_item)
  ...
  - [*player::complete_using_active_item [ Завершить использование предмета ]*](./player.md#player_complete_using_active_item)
  - [*player::connect_to_server [ Отправить игрока на другой сервер ]*](./player.md#player_connect_to_server)
  ...
  - [*player::mimic_disguise_from_entity [ Замаскировать игрока под сущность из мира ]*](./player.md#player_mimic_disguise_from_entity)
  ...
  - [*player::open_ender_chest [ Открыть Эндер-сундук ]*](./player.md#player_open_ender_chest)
  ...
  - [*player::reset_waypoint_color [ Сбросить цвет значка на локаторе ]*](./player.md#player_reset_waypoint_color)
  ...
  - [*player::set_inventory_menu_custom_id [ Установить кастомный ID открытого инвентаря ]*](./player.md#player_set_inventory_menu_custom_id)
  ...
  - [*player::set_waypoint_color [ Установить цвет значка на локаторе ]*](./player.md#player_set_waypoint_color)
  - [*player::set_waypoint_style [ Установить стиль значка на локаторе ]*](./player.md#player_set_waypoint_style)
  ...
  - [*player::start_using_item [ Начать использование предмета ]*](./player.md#player_start_using_item)
  ...
  - [*player::send_currency_transaction [ Запросить транзакцию ]*](./player.md#send_currency_transaction)
- **[variable](./variable.md)**
  - [*variable::block_is_minecraft_tagged [ Блок имеет Minecraft-тег ]*](./variable.md#if_variable_block_is_minecraft_tagged)
  ...
  - [*variable::item_is_minecraft_tagged [ Предмет имеет Minecraft-тег ]*](./variable.md#if_variable_item_is_minecraft_tagged)
  ...
  - [*variable::list_is_empty [ Значение пустое ]*](./variable.md#if_variable_list_is_empty)
  ...
  - [*variable::number_in_range [ В диапазоне ]*](./variable.md#if_variable_number_in_range)
  ...
  - [*variable::atan2 [ Арктангенс значений (atan2) ]*](./variable.md#set_variable_atan2)
  ...
  - [*variable::bytes_to_text [ Преобразовать байты в текст ]*](./variable.md#set_variable_bytes_to_text)
  - [*variable::center_location [ Получить центральное местоположение ]*](./variable.md#set_variable_center_location)
  - [*variable::change_component_parsing [ Изменить тип стилизуемого текста ]*](./variable.md#set_variable_change_component_parsing)
  - [*variable::char_to_number [ Получить число по символу ]*](./variable.md#set_variable_char_to_number)
  - [*variable::chunk_text [ Фрагментировать текст ]*](./variable.md#set_variable_chunk_text)
  - [*variable::clamp [ Ограничить число ]*](./variable.md#set_variable_clamp)
  - [*variable::clamp_location [ Ограничить местоположение ]*](./variable.md#set_variable_clamp_location)
  ...
  - [*variable::code_bytes [ Закодировать байты ]*](./variable.md#set_variable_code_bytes)
  ...
  - [*variable::create_head_object_component [ Создать стилизуемый текст с головой ]*](./variable.md#set_variable_create_head_object_component)
  ...
  - [*variable::create_sprite_object_component [ Создать стилизуемый текст со спрайтом ]*](./variable.md#set_variable_create_sprite_object_component)
  ...
  - [*variable::find_nearest_location [ Получить ближайшее местоположение ]*](./variable.md#set_variable_find_nearest_location)
  - [*variable::find_nearest_number [ Ближайшее число ]*](./variable.md#set_variable_find_nearest_number)
  ...
  - [*variable::get_blocks_by_tag [ Получить блоки по Minecraft-тегу ]*](./variable.md#set_variable_get_blocks_by_tag)
  ...
  - [*variable::get_entity_types_by_tag [ Получить сущностей по Minecraft-тегу ]*](./variable.md#set_variable_get_entity_types_by_tag)
  ...
  - [*variable::get_item_attack_range [ Получить радиус атаки ]*](./variable.md#set_variable_get_item_attack_range)
  ...
  - [*variable::get_item_minimum_attack_charge [ Получить минимальный заряд атаки ]*](./variable.md#set_variable_get_item_minimum_attack_charge)
  ...
  - [*variable::get_item_swing_animation [ Получить данные анимации замаха ]*](./variable.md#set_variable_get_item_swing_animation)
  ...
  - [*variable::get_items_by_tag [ Получить предметы по Minecraft-тегу ]*](./variable.md#set_variable_get_items_by_tag)
  ...
  - [*variable::get_text_regex_groups [ Разобрать по регулярному выражению ]*](./variable.md#set_variable_get_text_regex_groups)
  - [*variable::get_text_similarity [ Получить схожесть текстов ]*](./variable.md#set_variable_get_text_similarity)
  - [*variable::get_text_width [ Получить ширину текста в пикселях ]*](./variable.md#set_variable_get_text_width)
  - [*variable::get_tile_block_custom_tag [ Получить кастомный тег блока-сущности ]*](./variable.md#set_variable_get_tile_block_custom_tag)
  - [*variable::get_tile_block_nbt [ Получить NBT-теги блока-сущности ]*](./variable.md#set_variable_get_tile_block_nbt)
  ...
  - [*variable::mathematical_expectation [ Математическое ожидание ]*](./variable.md#set_variable_mathematical_expectation)
  - [*variable::max [ Максимальное значение ]*](./variable.md#set_variable_max)
  - [*variable::median [ Медианное значение ]*](./variable.md#set_variable_median)
  - [*variable::min [ Минимальное значение ]*](./variable.md#set_variable_min)
  - [*variable::set_values [ Установить значения нескольких переменных (=) ]*](./variable.md#set_variable_multiple)
  ...
  - [*variable::parse_to_component [ Установить тип стилизуемого текста ]*](./variable.md#set_variable_parse_to_component)
  ...
  - [*variable::set_component_shadow_color [ Установить цвет тени стилизуемого текста ]*](./variable.md#set_variable_set_component_shadow_color)
  ...
  - [*variable::set_item_attack_range [ Установить радиус атаки ]*](./variable.md#set_variable_set_item_attack_range)
  ...
  - [*variable::set_item_glider [ Установить предмету скольжение ]*](./variable.md#set_variable_set_item_glider)
  - [*variable::set_item_glint_override [ Переопределить свечение предмета ]*](./variable.md#set_variable_set_item_glint_override)
  - [*variable::set_item_hidden_tooltip [ Скрыть всплывающую подсказку предмета ]*](./variable.md#set_variable_set_item_hidden_tooltip)
  ...
  - [*variable::set_item_minimum_attack_charge [ Установить минимальный заряд атаки ]*](./variable.md#set_variable_set_item_minimum_attack_charge)
  - [*variable::set_item_model_data [ Установить модель предмета ]*](./variable.md#set_variable_set_item_model_data)
  - [*variable::set_item_name [ Установить имя предмета ]*](./variable.md#set_variable_set_item_name)
  - [*variable::set_item_piercing_weapon [ Установить пробитие ]*](./variable.md#set_variable_set_item_piercing_weapon)
  ...
  - [*variable::set_item_rarity [ Установить редкость предмета ]*](./variable.md#set_variable_set_item_rarity)
  - [*variable::set_item_swing_animation [ Установить данные анимации замаха ]*](./variable.md#set_variable_set_item_swing_animation)
  - [*variable::set_item_tooltip_style [ Установить стиль всплывающей подсказки предмета ]*](./variable.md#set_variable_set_item_tooltip_style)
  ...
  - [*variable::set_item_use_effects [ Установить эффекты использования ]*](./variable.md#set_variable_set_item_use_effects)
  - [*variable::set_item_use_remainder [ Установить превращение предмета ]*](./variable.md#set_variable_set_item_use_remainder)
  ...
  - [*variable::set_item_weapon [ Установить предмету данные компонента оружия ]*](./variable.md#set_variable_set_item_weapon)
  ...
  - [*variable::split_text_by_length [ Перенос по словам ]*](./variable.md#set_variable_split_text_by_length)
  ...
  - [*variable::text_to_bytes [ Преобразовать текст в байты ]*](./variable.md#set_variable_text_to_bytes)
  - [*variable::text_to_chars [ Преобразовать текст в символы ]*](./variable.md#set_variable_text_to_chars)
  ...
  - [*variable::unset_item_components [ Удалить компоненты предмета ]*](./variable.md#set_variable_unset_item_components)
