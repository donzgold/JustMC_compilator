...
- **[world](./world.md)**
  ...
  - [*world::event_has_input [ Клавиша передвижения ]*](./world.md#if_game_event_has_input)
...
- **[variable](./variable.md)**
  ...
  - [*variable::edit_item_custom_nodel_data [ Изменить данные о модели предмета ]*](./variable.md#set_variable_edit_item_custom_nodel_data)
