...
| locations | Список\[Местоположение\]                                     | Местоположения концов прямых<br/>Аргумент поддерживает разложение списков |
...
| rotate_location | Маркер<br/>**INWARDS** - К центру<br/>**NO_CHANGES** - Как в местоположении<br/>**OUTWARDS** - От центра | Направление местоположения у точек    |
