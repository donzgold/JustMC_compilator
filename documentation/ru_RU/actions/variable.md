...
| `variable` | Переменная             | Переменная для присвоения |
| `item`     | Предмет                | Предмет                   |
| `property` | Маркер<br/>**** - None | Значение                  |
...
| ---------- | ---------------------------------------------------------------------------------- | ------------------------- |
| `variable` | Переменная                                                                         | Переменная для присвоения |
| `scope`    | Маркер<br/>**GAME** - Игровые<br/>**LOCAL** - Локальные<br/>**SAVE** - Сохранённые | Тип переменных            |
...
| `type`       | Маркер<br/>**ALTITUDE** - По высоте<br/>**THREE_D** - В объёме<br/>**TWO_D** - В плоскости | Тип расстояния            |
