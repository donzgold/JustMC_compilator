...
| compare         | Список\[Предмет\]                                                                                                                                                                                                    | Сравниваемые значения<br>Аргумент поддерживает разложение списков |
...
| item         | Предмет                                                                                                                                          | Предметная переменная                                     |
| tag          | Текст                                                                                                                                            | Имя тега                                                  |
| value        | Список\[Текст\]                                                                                                                                  | Значение тега<br>Аргумент поддерживает разложение списков |
...
| values     | Список\[Любое значение\]                                       | Значения для проверки<br>Аргумент поддерживает разложение списков |
...
| check    | Список\[Местоположение\]                                                                        | Местоположение центра фигуры<br>Аргумент поддерживает разложение списков |
...
| key        | Список\[Любое значение\]                                                         | Ключ<br>Аргумент поддерживает разложение списков |
...
| compare     | Список\[Текст\]                              | Текст для проверки<br>Аргумент поддерживает разложение списков |
...
| compare     | Список\[Текст\]                              | Текст для сравнения<br>Аргумент поддерживает разложение списков |
| ignore_case | Маркер<br/>**FALSE** - Нет<br/>**TRUE** - Да | Игнорировать регистр                                            |
...
| values              | Список\[Текст\]                                                  | Текстовые переменные для проверки<br>Аргумент поддерживает разложение списков |
...
|---------------|------------------------------------------------------------------------------|-----------------------------------------------------------|
| variable      | Переменная\[Предмет\]                                                        | Переменная для присвоения                                 |
| potions       | Список\[Зелье\]                                                              | Эффекты зелий<br>Аргумент поддерживает разложение списков |
| item          | Предмет                                                                      | Предмет                                                   |
...
| components | Список\[Текст\]                                                                                                               | Стилизуемые тексты для объединения<br>Аргумент поддерживает разложение списков |
...
|----------|----------------------------------------------------------------------------|----------------------------------------------------------------------|
| variable | Переменная\[Текст\]                                                        | Переменная для присвоения                                            |
| bytes    | Список\[Число\]                                                            | Байты для преобразования<br>Аргумент поддерживает разложение списков |
...
|----------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|------------------------------------------------------------|
| variable | Переменная\[Список\]                                                                                                                                                                  | Переменная для присвоения                                  |
| input    | Список\[Число\]                                                                                                                                                                       | Входящие байты<br>Аргумент поддерживает разложение списков |
...
|---------------|--------------------------------------------------------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------|
| variable      | Переменная\[Число\]                                                                                                                                          | Переменная для присвоения                                     |
| value         | Список\[Число\]                                                                                                                                              | Числа для деления<br>Аргумент поддерживает разложение списков |
...
| variable   | Переменная\[Предмет\]                                                                                                                                                                    | Переменная для присвоения                          |
| item       | Предмет                                                                                                                                                                                  | Предмет                                            |
| data       | Список\[Любое значение\]                                                                                                                                                                 | Данные<br>Аргумент поддерживает разложение списков |
...
| variable      | Переменная\[Местоположение\]                                                 | Переменная для присвоения                                             |
| location      | Местоположение                                                               | Местоположение                                                        |
| locations     | Список\[Местоположение\]                                                     | Местоположения для поиска<br>Аргумент поддерживает разложение списков |
...
|-------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------|
| variable    | Переменная\[Список\]                                                                                                                                                                         | Переменная для присвоения                                    |
| names       | Список\[Текст\]                                                                                                                                                                              | Имена переменных<br>Аргумент поддерживает разложение списков |
...
| variable   | Переменная\[Предмет\]                                                             | Переменная для присвоения                                     |
| item       | Предмет                                                                           | Предмет                                                       |
| components | Список\[Текст\]                                                                   | Ключи компонентов<br>Аргумент поддерживает разложение списков |
...
|---------------|---------------------|---------------------------------------------------------|
| variable      | Переменная\[Число\] | Переменная для присвоения                               |
| values        | Список\[Число\]     | Исходы<br>Аргумент поддерживает разложение списков      |
...
| ID          | Тип                                                                                                                                                                                                               | Описание                                                        |
|-------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| names       | Список\[Текст\]                                                                                                                                                                                                   | Имена для сравнения<br>Аргумент поддерживает разложение списков |
...
|----------|-----------------------|-----------------------------------------------------------|
| variable | Переменная\[Предмет\] | Переменная для присвоения                                 |
| effects  | Список\[Зелье\]       | Эффекты зелий<br>Аргумент поддерживает разложение списков |
| item     | Предмет               | Предмет                                                   |
...
|----------|----------------------------------------------------------|----------------------------------------------------------------|
| variable | Переменная\[Текст\]                                      | Переменная для присвоения                                      |
| remove   | Список\[Текст\]                                          | Текст для удаления<br>Аргумент поддерживает разложение списков |
| text     | Текст                                                    | Исходный текст                                                 |
...
| variable     | Переменная\[Предмет\]                                                           | Переменная для присвоения                                          |
| bundle       | Предмет                                                                         | Мешок                                                              |
| items        | Список\[Предмет\]                                                               | Предметы для изменения<br>Аргумент поддерживает разложение списков |
...
|-------------|-----------------------|-----------------------------------------------------------------------------------|
| variable    | Переменная\[Предмет\] | Переменная для присвоения                                                         |
| destroyable | Список\[Предмет\]     | Блоки, которые можно ломать предметом<br>Аргумент поддерживает разложение списков |
| item        | Предмет               | Предмет                                                                           |
...
|-----------|-----------------------|---------------------------------------------------------------------------------------|
| variable  | Переменная\[Предмет\] | Переменная для присвоения                                                             |
| placeable | Список\[Предмет\]     | Блоки, на которые можно поставить предмет<br>Аргумент поддерживает разложение списков |
| item      | Предмет               | Предмет                                                                               |
...
|----------|-------------------------------------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| variable | Переменная\[Текст\]                                                                                                           | Переменная для присвоения                                       |
| text     | Список\[Текст\]                                                                                                               | Текст для установки<br>Аргумент поддерживает разложение списков |
| merging  | Маркер<br/>**CONCATENATION** - Объединение<br/>**SEPARATE_LINES** - Разделение на строки<br/>**SPACES** - Разделение пробелом | Объединение текста                                              |
