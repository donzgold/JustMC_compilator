...
- Классы
- Начиная с этой версии, у jmcc теперь есть плагин(ссылко) и клиентский мод(ссылко)
- Способ создания маркеров для функций
- Измерение скорости работы кода
- Способ создания документации и базы кода раскрыт

Изменено:
- Способ реализации параметров функций для использования возможностей джаста
- Описание функций для совпадения с форматом джаста
